...
public class ElectWave extends SkillButton{
    ...
    public ElectWave(int x, int y, Style style, Global.SkillName skillName, int cost){
        ...
        selectedLabel=new Label(this.getCenterX()-64,this.getCenterY()-64,new Style.StyleRect(64,64,true,new BackgroundType.BackgroundImage(ImageController.getInstance().tryGet("/SB-elecWave.png"))));
